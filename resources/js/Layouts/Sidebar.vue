...
<div class="flex min-h-screen">
    <div id="sidebar" class="bg-red-900 p-6 duration-500" :class="width" style="position: relative;">
        ...
        <div id="branding" :class="hidden">
            <img src="https://as2.ftcdn.net/v2/jpg/04/61/69/79/1000_F_461697922_oP6vuw6M8m9BQ29LTfIz5NunU8T1B5Ni.jpg" alt="Logo"
                class="w-[170px] h-[170px] mx-auto rounded-full object-cover">
            <h1 class="text-3xl text-center text-white my-6">ANGELA LENTERIA</h1>
